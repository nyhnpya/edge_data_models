...
namespace Downhole {
    ...
    /* ========================================================================= */
    const char *WellboreTYPENAME = "Downhole::Wellbore";

    DDS_TypeCode* Wellbore_get_typecode()
    {
        static RTIBool is_initialized = RTI_FALSE;

        static DDS_TypeCode_Member Wellbore_g_tc_members[6]=
        {
        ...
        Wellbore_g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)DataTypes::Time_get_typecode();

        Wellbore_g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_double;
    ...
    RTIBool Wellbore_initialize(
        Wellbore* sample) {
        return Downhole::Wellbore_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        Wellbore* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return Downhole::Wellbore_initialize_w_params(
            sample,&allocParams);
        ...
        Wellbore* sample)
    {
        ...
        Downhole::Wellbore_finalize_ex(sample,RTI_TRUE);
    }
        ...
        Wellbore* sample,RTIBool deletePointers)
    {
        ...
        Downhole::Wellbore_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params Downhole::Wellbore_initialize_w_params
    #define T_finalize_w_params   Downhole::Wellbore_finalize_w_params
    #define T_copy       Downhole::Wellbore_copy
