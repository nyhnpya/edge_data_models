...
namespace Simulation {
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        return Simulation::AutoDrillerRequestPluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    AutoDrillerRequestPluginSupport_destroy_data(
        ...
        Simulation::AutoDrillerRequestPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return  Simulation::AutoDrillerRequestPluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    AutoDrillerRequestPluginSupport_destroy_key(
        ...
        Simulation::AutoDrillerRequestPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            Simulation::AutoDrillerRequestPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Simulation::AutoDrillerRequestPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Simulation::AutoDrillerRequestPluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Simulation::AutoDrillerRequestPluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Simulation::AutoDrillerRequestPlugin_get_serialized_key_max_size(
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Simulation::AutoDrillerRequestPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                Simulation::AutoDrillerRequestPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Simulation::AutoDrillerRequestPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
        ...
        const AutoDrillerRequest *src)
    {
        ...
        return Simulation::AutoDrillerRequestPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        result= Simulation::AutoDrillerRequestPlugin_deserialize_sample( 
    ...
    RTIBool AutoDrillerRequestPlugin_skip(
        PRESTypePluginEndpointData endpoint_data,
        struct RTICdrStream *stream,   
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerRequestPlugin_get_serialized_sample_max_size_ex(
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool AutoDrillerRequestPlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerRequest *sample, 
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Simulation::AutoDrillerRequestPlugin_deserialize_key_sample(
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerRequestPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    AutoDrillerRequestPlugin_instance_to_key(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerRequestKeyHolder *dst, 
        const AutoDrillerRequest *src)
    {
    ...
    AutoDrillerRequestPlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerRequest *dst, const
        AutoDrillerRequestKeyHolder *src)
    {
        ...
        const AutoDrillerRequest *instance)
    {
            ...
            NULL)) 
        {
            ...
            size = (int)Simulation::AutoDrillerRequestPlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!Simulation::AutoDrillerRequestPlugin_instance_to_keyhash(
    ...
    * ------------------------------------------------------------------------ */
    struct PRESTypePlugin *AutoDrillerRequestPlugin_new(void) 
    { 
        ...
        Simulation::AutoDrillerRequestPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Simulation::AutoDrillerRequestPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Simulation::AutoDrillerRequestPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Simulation::AutoDrillerRequestPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Simulation::AutoDrillerRequestPlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        AutoDrillerRequestPlugin_create_sample;
        ...
        Simulation::AutoDrillerRequestPlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Simulation::AutoDrillerRequestPlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Simulation::AutoDrillerRequestPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Simulation::AutoDrillerRequestPlugin_get_serialized_sample_min_size;

        plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        AutoDrillerRequestPlugin_get_sample;
        ...
        Simulation::AutoDrillerRequestPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Simulation::AutoDrillerRequestPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Simulation::AutoDrillerRequestPlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Simulation::AutoDrillerRequestPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Simulation::AutoDrillerRequestPlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Simulation::AutoDrillerRequestPlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Simulation::AutoDrillerRequestPlugin_serialized_sample_to_keyhash;

        plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        AutoDrillerRequestPlugin_get_key;
        plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        AutoDrillerRequestPlugin_return_key;

        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        Simulation::AutoDrillerRequestPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Simulation::AutoDrillerRequestPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Simulation::AutoDrillerRequest_get_typecode();
        ...
        AutoDrillerRequestPlugin_get_buffer;
        plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        AutoDrillerRequestPlugin_return_buffer;
        plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        Simulation::AutoDrillerRequestPlugin_get_serialized_sample_size;

        plugin->endpointTypeName = AutoDrillerRequestTYPENAME;

        return plugin;
    }

    void
    AutoDrillerRequestPlugin_delete(struct PRESTypePlugin *plugin)
    {
        RTIOsapiHeap_freeStructure(plugin);
    } 

    /* ----------------------------------------------------------------------------
    *  Type AutoDrillerObjective
    * -------------------------------------------------------------------------- */
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        return Simulation::AutoDrillerObjectivePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    AutoDrillerObjectivePluginSupport_destroy_data(
        ...
        Simulation::AutoDrillerObjectivePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return  Simulation::AutoDrillerObjectivePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    AutoDrillerObjectivePluginSupport_destroy_key(
        ...
        Simulation::AutoDrillerObjectivePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            Simulation::AutoDrillerObjectivePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Simulation::AutoDrillerObjectivePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Simulation::AutoDrillerObjectivePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Simulation::AutoDrillerObjectivePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Simulation::AutoDrillerObjectivePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return Simulation::AutoDrillerObjectivePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Simulation::AutoDrillerObjectivePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    RTIBool AutoDrillerObjectivePlugin_skip(
        PRESTypePluginEndpointData endpoint_data,
        struct RTICdrStream *stream,   
        RTIBool skip_encapsulation,
        RTIBool skip_sample, 
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerObjectivePlugin_get_serialized_sample_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool AutoDrillerObjectivePlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerObjective *sample, 
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Simulation::AutoDrillerObjectivePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerObjectivePlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    AutoDrillerObjectivePlugin_instance_to_key(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerObjectiveKeyHolder *dst, 
        const AutoDrillerObjective *src)
    {
    ...
    AutoDrillerObjectivePlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerObjective *dst, const
        AutoDrillerObjectiveKeyHolder *src)
    {
        ...
        const AutoDrillerObjective *instance)
    {
            ...
            NULL)) 
        {
            ...
            size = (int)Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!Simulation::AutoDrillerObjectivePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * Plug-in Installation Methods
    * ------------------------------------------------------------------------ */
    struct PRESTypePlugin *AutoDrillerObjectivePlugin_new(void) 
    { 
        struct PRESTypePlugin *plugin = NULL;
        const struct PRESTypePluginVersion PLUGIN_VERSION = 
        PRES_TYPE_PLUGIN_VERSION_2_0;
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        Simulation::AutoDrillerObjectivePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Simulation::AutoDrillerObjectivePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Simulation::AutoDrillerObjectivePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Simulation::AutoDrillerObjectivePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Simulation::AutoDrillerObjectivePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        AutoDrillerObjectivePlugin_create_sample;
        plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        Simulation::AutoDrillerObjectivePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Simulation::AutoDrillerObjectivePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_min_size;

        plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        AutoDrillerObjectivePlugin_get_sample;
        plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        AutoDrillerObjectivePlugin_return_sample;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        Simulation::AutoDrillerObjectivePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Simulation::AutoDrillerObjectivePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Simulation::AutoDrillerObjectivePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Simulation::AutoDrillerObjectivePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Simulation::AutoDrillerObjectivePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Simulation::AutoDrillerObjectivePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Simulation::AutoDrillerObjectivePlugin_serialized_sample_to_keyhash;

        plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        AutoDrillerObjectivePlugin_get_key;
        plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        AutoDrillerObjectivePlugin_return_key;

        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        Simulation::AutoDrillerObjectivePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Simulation::AutoDrillerObjectivePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Simulation::AutoDrillerObjective_get_typecode();
        ...
        plugin->getBuffer = 
        (PRESTypePluginGetBufferFunction)
        AutoDrillerObjectivePlugin_get_buffer;
        plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        AutoDrillerObjectivePlugin_return_buffer;
        plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        Simulation::AutoDrillerObjectivePlugin_get_serialized_sample_size;

        plugin->endpointTypeName = AutoDrillerObjectiveTYPENAME;

        return plugin;
    }

    void
    AutoDrillerObjectivePlugin_delete(struct PRESTypePlugin *plugin)
    {
        RTIOsapiHeap_freeStructure(plugin);
    } 

    /* ----------------------------------------------------------------------------
    *  Type AutoDrillerState
    * -------------------------------------------------------------------------- */
    ...
    * -------------------------------------------------------------------------- */
    ...
    {
        return Simulation::AutoDrillerStatePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    AutoDrillerStatePluginSupport_destroy_data(
        ...
        Simulation::AutoDrillerStatePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return  Simulation::AutoDrillerStatePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    AutoDrillerStatePluginSupport_destroy_key(
        ...
        Simulation::AutoDrillerStatePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            Simulation::AutoDrillerStatePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Simulation::AutoDrillerStatePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Simulation::AutoDrillerStatePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Simulation::AutoDrillerStatePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Simulation::AutoDrillerStatePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Simulation::AutoDrillerStatePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                Simulation::AutoDrillerStatePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Simulation::AutoDrillerStatePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return Simulation::AutoDrillerStatePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Simulation::AutoDrillerStatePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    RTIBool AutoDrillerStatePlugin_skip(
        PRESTypePluginEndpointData endpoint_data,
        struct RTICdrStream *stream,   
        RTIBool skip_encapsulation,
        RTIBool skip_sample, 
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerStatePlugin_get_serialized_sample_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    * -------------------------------------------------------------------------------------- */
    ...
    RTIBool AutoDrillerStatePlugin_deserialize_key_sample(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerState *sample, 
        struct RTICdrStream *stream,
        RTIBool deserialize_encapsulation,
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Simulation::AutoDrillerStatePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        unsigned int current_alignment)
    {
        ...
        size = AutoDrillerStatePlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    AutoDrillerStatePlugin_key_to_instance(
        PRESTypePluginEndpointData endpoint_data,
        AutoDrillerState *dst, const
        AutoDrillerStateKeyHolder *src)
    {
        ...
        const AutoDrillerState *instance)
    {
            ...
            NULL)) 
        {
            ...
            size = (int)Simulation::AutoDrillerStatePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!Simulation::AutoDrillerStatePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * Plug-in Installation Methods
    * ------------------------------------------------------------------------ */
    struct PRESTypePlugin *AutoDrillerStatePlugin_new(void) 
    { 
        struct PRESTypePlugin *plugin = NULL;
        const struct PRESTypePluginVersion PLUGIN_VERSION = 
        PRES_TYPE_PLUGIN_VERSION_2_0;
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        Simulation::AutoDrillerStatePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Simulation::AutoDrillerStatePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Simulation::AutoDrillerStatePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Simulation::AutoDrillerStatePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Simulation::AutoDrillerStatePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        AutoDrillerStatePlugin_create_sample;
        plugin->destroySampleFnc =
        (PRESTypePluginDestroySampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        Simulation::AutoDrillerStatePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Simulation::AutoDrillerStatePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Simulation::AutoDrillerStatePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Simulation::AutoDrillerStatePlugin_get_serialized_sample_min_size;

        plugin->getSampleFnc =
        (PRESTypePluginGetSampleFunction)
        AutoDrillerStatePlugin_get_sample;
        plugin->returnSampleFnc =
        (PRESTypePluginReturnSampleFunction)
        AutoDrillerStatePlugin_return_sample;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        Simulation::AutoDrillerStatePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Simulation::AutoDrillerStatePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Simulation::AutoDrillerStatePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Simulation::AutoDrillerStatePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Simulation::AutoDrillerStatePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Simulation::AutoDrillerStatePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Simulation::AutoDrillerStatePlugin_serialized_sample_to_keyhash;

        plugin->getKeyFnc =
        (PRESTypePluginGetKeyFunction)
        AutoDrillerStatePlugin_get_key;
        plugin->returnKeyFnc =
        (PRESTypePluginReturnKeyFunction)
        AutoDrillerStatePlugin_return_key;

        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        Simulation::AutoDrillerStatePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Simulation::AutoDrillerStatePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Simulation::AutoDrillerState_get_typecode();
        ...
        plugin->getBuffer = 
        (PRESTypePluginGetBufferFunction)
        AutoDrillerStatePlugin_get_buffer;
        plugin->returnBuffer = 
        (PRESTypePluginReturnBufferFunction)
        AutoDrillerStatePlugin_return_buffer;
        plugin->getSerializedSampleSizeFnc =
        (PRESTypePluginGetSerializedSampleSizeFunction)
        Simulation::AutoDrillerStatePlugin_get_serialized_sample_size;

        plugin->endpointTypeName = AutoDrillerStateTYPENAME;

        return plugin;
    }

    void
    AutoDrillerStatePlugin_delete(struct PRESTypePlugin *plugin)
    {
        RTIOsapiHeap_freeStructure(plugin);
    } 
} /* namespace Simulation  */
