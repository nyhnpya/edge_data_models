 ...
 */
#ifndef __CIRCULATE_ENGINEERING_STATE_SUBSCRIBER_H__ 
#define __CIRCULATE_ENGINEERING_STATE_SUBSCRIBER_H__ 
...
public:
    ...
    virtual ~CCirculateEngineeringStateSubscriber();
...
#endif // __CIRCULATE_ENGINEERING_STATE_SUBSCRIBER_H__ 
