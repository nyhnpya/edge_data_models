...
void CDrillStateTopicSubscriber::OnSubscriptionMatched(OnSubscriptionMatchedEvent event)
{
...
void CDrillStateTopicSubscriber::SubscriptionMatched(const DDS::SubscriptionMatchedStatus &status)
{
