...
namespace PipeHandling {
    ...
    /* ========================================================================= */
    const char *PipeTallyTYPENAME = "PipeHandling::PipeTally";
    ...
    DDS_TypeCode* PipeTally_get_typecode()
    {
        ...
        {{
                ...
                -1, /*Ignored*/
                (char *)"PipeHandling::PipeTally", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool PipeTally_initialize(
        PipeTally* sample) {
        return PipeHandling::PipeTally_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        PipeTally* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return PipeHandling::PipeTally_initialize_w_params(
            sample,&allocParams);
        ...
        PipeTally* sample)
    {
        ...
        PipeHandling::PipeTally_finalize_ex(sample,RTI_TRUE);
    }
        ...
        PipeTally* sample,RTIBool deletePointers)
    {
        ...
        PipeHandling::PipeTally_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params PipeHandling::PipeTally_initialize_w_params
    #define T_finalize_w_params   PipeHandling::PipeTally_finalize_w_params
    #define T_copy       PipeHandling::PipeTally_copy
