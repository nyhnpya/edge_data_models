...
namespace PipeHandling {
    ...
    * -------------------------------------------------------------------------- */
    ...
    PipeTallyPluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!PipeHandling::PipeTally_initialize_w_params(sample,alloc_params)) {
    ...
    PipeTallyPluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!PipeHandling::PipeTally_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return PipeHandling::PipeTallyPluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    PipeTallyPluginSupport_destroy_data_w_params(
        ...
        PipeHandling::PipeTally_finalize_w_params(sample,dealloc_params);
    ...
    PipeTallyPluginSupport_destroy_data_ex(
        ...
        PipeHandling::PipeTally_finalize_ex(sample,deallocate_pointers);
    ...
    PipeTallyPluginSupport_destroy_data(
        ...
        PipeHandling::PipeTallyPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    PipeTallyPluginSupport_copy_data(
        ...
        const PipeTally *src)
    {
        return PipeHandling::PipeTally_copy(dst,src);
    }
    ...
    PipeTallyPluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        PipeHandling::PipeTally_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  PipeHandling::PipeTallyPluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        PipeHandling::PipeTally_finalize_ex(key,deallocate_pointers);
    ...
    PipeTallyPluginSupport_destroy_key(
        ...
        PipeHandling::PipeTallyPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            PipeHandling::PipeTallyPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            PipeHandling::PipeTallyPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            PipeHandling::PipeTallyPluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            PipeHandling::PipeTallyPluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  PipeHandling::PipeTallyPlugin_get_serialized_key_max_size(
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = PipeHandling::PipeTallyPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                PipeHandling::PipeTallyPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PipeHandling::PipeTallyPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
        ...
        const PipeTally *src)
    {
        ...
        return PipeHandling::PipeTallyPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            PipeHandling::PipeTally_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const PipeTally *sample)
    {
        ...
        result = PipeHandling::PipeTallyPlugin_serialize(
        ...
        void *endpoint_plugin_qos)
    {
        ...
        result= PipeHandling::PipeTallyPlugin_deserialize_sample( 
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= PipeHandling::PipeTallyPlugin_deserialize_key_sample(
        ...
        const PipeTally *instance)
    {
        ...
        if (!PipeHandling::PipeTallyPlugin_serialize_key(
            ...
            size = (int)PipeHandling::PipeTallyPlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
    ...
    {   
      ...
      fin:
        ...
        if (!PipeHandling::PipeTallyPlugin_instance_to_keyhash(
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        PipeHandling::PipeTallyPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        PipeHandling::PipeTallyPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        PipeHandling::PipeTallyPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        PipeHandling::PipeTallyPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        PipeHandling::PipeTallyPlugin_copy_sample;
        ...
        PipeHandling::PipeTallyPlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        PipeHandling::PipeTallyPlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        PipeHandling::PipeTallyPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        PipeHandling::PipeTallyPlugin_get_serialized_sample_min_size;
        ...
        PipeHandling::PipeTallyPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        PipeHandling::PipeTallyPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        PipeHandling::PipeTallyPlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        PipeHandling::PipeTallyPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        PipeHandling::PipeTallyPlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        PipeHandling::PipeTallyPlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        PipeHandling::PipeTallyPlugin_serialized_sample_to_keyhash;
        ...
        PipeHandling::PipeTallyPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        PipeHandling::PipeTallyPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)PipeHandling::PipeTally_get_typecode();
