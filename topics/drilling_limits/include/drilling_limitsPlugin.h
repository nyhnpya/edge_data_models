...
#ifndef drilling_limitsPlugin_429958456_h
#define drilling_limitsPlugin_429958456_h
...
namespace process {
    namespace plan {
        ...
        * -------------------------------------------------------------------------------------- */
        ...
        struct RTIXCdrInterpreterPrograms * DrillingLimitsPlugin_get_programs(void);
...
#endif /* drilling_limitsPlugin_429958456_h */
