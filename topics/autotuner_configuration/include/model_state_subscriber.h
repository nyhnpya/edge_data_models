 ...
 */
#ifndef __SHELL_HMI_AUTOTUNERCONFIGURATION_MODEL_STATE_SUBSCRIBER_H__
#define __SHELL_HMI_AUTOTUNERCONFIGURATION_MODEL_STATE_SUBSCRIBER_H__
...
///
///
class CModelStateSubscriber : public TSubscriber< Shell::Hmi::AutoTunerConfiguration::ModelState >
{
    public:
        CModelStateSubscriber();
        ~CModelStateSubscriber();
    ...
    protected:
        void DataAvailable(const Shell::Hmi::AutoTunerConfiguration::ModelState &data,
                           const DDS::SampleInfo &sampleInfo);
        void DataDisposed(const DDS::SampleInfo &sampleInfo);
        void LivelinessChanged(const DDS::LivelinessChangedStatus &status);

    private:
        Shell::Hmi::AutoTunerConfiguration::ModelState                        m_data;
...
#endif // __SHELL_HMI_AUTOTUNERCONFIGURATION_MODEL_STATE_SUBSCRIBER_H__
