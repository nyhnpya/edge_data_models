    ...
    namespace plan {
        ...
        * ---------------------------------------------------------------------------- */
            ...
            void *containerPluginContext)
        {
            ...
            epd = PRESTypePluginDefaultEndpointData_new(
                ...
                process::plan::ObjectiveStatePluginSupport_create_key ,            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            ...
            serializedKeyMaxSizeV2 =  ObjectiveStatePlugin_get_serialized_key_max_size_for_keyhash(
                epd,
        ...
        * ------------------------------------------------------------------------- */
            ...
            DDS_DataRepresentationId_t representation)
        {
            ...
            ObjectiveState_get_typecode();
            pd.programs = ObjectiveStatePlugin_get_programs();
            if (pd.programs == NULL) {
                return RTI_FALSE;
            }
        ...
        ObjectiveStatePlugin_serialize_to_cdr_buffer(
            ...
            const ObjectiveState *sample)
        {
            return ObjectiveStatePlugin_serialize_to_cdr_buffer_ex(
                buffer,
                length,
                sample,
        ...
        * ------------------------------------------------------------------------ */
        ...
        { 
            ...
            ObjectiveState_finalize_optional_members;
