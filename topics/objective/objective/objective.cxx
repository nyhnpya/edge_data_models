...
namespace Plan {
    ...
    /* ========================================================================= */
    const char *ObjectiveStateTYPENAME = "Plan::ObjectiveState";
    ...
    RTIBool ObjectiveState_initialize(
        ...
        return Plan::ObjectiveState_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        ObjectiveState* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return Plan::ObjectiveState_initialize_w_params(
            sample,&allocParams);
        ...
        ObjectiveState* sample)
    {
        ...
        Plan::ObjectiveState_finalize_ex(sample,RTI_TRUE);
    }
        ...
        ObjectiveState* sample,RTIBool deletePointers)
    {
        ...
        Plan::ObjectiveState_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params Plan::ObjectiveState_initialize_w_params
    #define T_finalize_w_params   Plan::ObjectiveState_finalize_w_params
    #define T_copy       Plan::ObjectiveState_copy
