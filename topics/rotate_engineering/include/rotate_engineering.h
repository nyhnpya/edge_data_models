...
namespace rti { 
    namespace xcdr {
        template <>
        struct type_code<nec::engineering::RotateEngineeringRequest> {
            static const RTIXCdrTypeCode * get();
        };

        template <>
        struct type_code<nec::engineering::RotateEngineeringObjective> {
            static const RTIXCdrTypeCode * get();
        };

        template <>
        struct type_code<nec::engineering::RotateEngineeringState> {
            static const RTIXCdrTypeCode * get();
        };
