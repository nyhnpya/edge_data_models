...
namespace EngineeringRotation {
    ...
    /* ========================================================================= */
    const char *RotateEngineeringRequestTYPENAME = "EngineeringRotation::RotateEngineeringRequest";
    ...
    DDS_TypeCode* RotateEngineeringRequest_get_typecode()
    {
        ...
        {{
                ...
                -1, /*Ignored*/
                (char *)"EngineeringRotation::RotateEngineeringRequest", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool RotateEngineeringRequest_initialize(
        ...
        return EngineeringRotation::RotateEngineeringRequest_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        RotateEngineeringRequest* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return EngineeringRotation::RotateEngineeringRequest_initialize_w_params(
            sample,&allocParams);
        ...
        RotateEngineeringRequest* sample)
    {
        ...
        EngineeringRotation::RotateEngineeringRequest_finalize_ex(sample,RTI_TRUE);
    }
        ...
        RotateEngineeringRequest* sample,RTIBool deletePointers)
    {
        ...
        EngineeringRotation::RotateEngineeringRequest_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params EngineeringRotation::RotateEngineeringRequest_initialize_w_params
    #define T_finalize_w_params   EngineeringRotation::RotateEngineeringRequest_finalize_w_params
    #define T_copy       EngineeringRotation::RotateEngineeringRequest_copy
    ...
    /* ========================================================================= */
    const char *RotateEngineeringObjectiveTYPENAME = "EngineeringRotation::RotateEngineeringObjective";
    ...
    DDS_TypeCode* RotateEngineeringObjective_get_typecode()
    {
        ...
        {{
                ...
                DDS_BOOLEAN_FALSE, /* Ignored */
                -1, /*Ignored*/
                (char *)"EngineeringRotation::RotateEngineeringObjective", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool RotateEngineeringObjective_initialize(
        ...
        return EngineeringRotation::RotateEngineeringObjective_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        RotateEngineeringObjective* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return EngineeringRotation::RotateEngineeringObjective_initialize_w_params(
            sample,&allocParams);
        ...
        RotateEngineeringObjective* sample)
    {
        ...
        EngineeringRotation::RotateEngineeringObjective_finalize_ex(sample,RTI_TRUE);
    }
        ...
        RotateEngineeringObjective* sample,RTIBool deletePointers)
    {
        ...
        EngineeringRotation::RotateEngineeringObjective_finalize_w_params(
            sample,&deallocParams);
    }
    ...
    */
    ...
    #define T_initialize_w_params EngineeringRotation::RotateEngineeringObjective_initialize_w_params
    #define T_finalize_w_params   EngineeringRotation::RotateEngineeringObjective_finalize_w_params
    #define T_copy       EngineeringRotation::RotateEngineeringObjective_copy
    ...
    /* ========================================================================= */
    const char *RotateEngineeringStateTYPENAME = "EngineeringRotation::RotateEngineeringState";
    ...
    DDS_TypeCode* RotateEngineeringState_get_typecode()
    {
        ...
        {{
                ...
                DDS_BOOLEAN_FALSE, /* Ignored */
                -1, /*Ignored*/
                (char *)"EngineeringRotation::RotateEngineeringState", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool RotateEngineeringState_initialize(
        ...
        return EngineeringRotation::RotateEngineeringState_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        RotateEngineeringState* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return EngineeringRotation::RotateEngineeringState_initialize_w_params(
            sample,&allocParams);
        ...
        RotateEngineeringState* sample)
    {
        ...
        EngineeringRotation::RotateEngineeringState_finalize_ex(sample,RTI_TRUE);
    }
        ...
        RotateEngineeringState* sample,RTIBool deletePointers)
    {
        ...
        EngineeringRotation::RotateEngineeringState_finalize_w_params(
            sample,&deallocParams);
    }
    ...
    */
    ...
    #define T_initialize_w_params EngineeringRotation::RotateEngineeringState_initialize_w_params
    #define T_finalize_w_params   EngineeringRotation::RotateEngineeringState_finalize_w_params
    #define T_copy       EngineeringRotation::RotateEngineeringState_copy
