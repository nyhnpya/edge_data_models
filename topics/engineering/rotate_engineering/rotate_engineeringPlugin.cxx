...
namespace EngineeringRotation {
    ...
    * -------------------------------------------------------------------------- */
    ...
    RotateEngineeringRequestPluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringRequest_initialize_w_params(sample,alloc_params)) {
    ...
    RotateEngineeringRequestPluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringRequest_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return EngineeringRotation::RotateEngineeringRequestPluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    RotateEngineeringRequestPluginSupport_destroy_data_w_params(
        ...
        EngineeringRotation::RotateEngineeringRequest_finalize_w_params(sample,dealloc_params);
    ...
    RotateEngineeringRequestPluginSupport_destroy_data_ex(
        ...
        EngineeringRotation::RotateEngineeringRequest_finalize_ex(sample,deallocate_pointers);
    ...
    RotateEngineeringRequestPluginSupport_destroy_data(
        ...
        EngineeringRotation::RotateEngineeringRequestPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return EngineeringRotation::RotateEngineeringRequest_copy(dst,src);
    }
    ...
    RotateEngineeringRequestPluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        EngineeringRotation::RotateEngineeringRequest_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  EngineeringRotation::RotateEngineeringRequestPluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        EngineeringRotation::RotateEngineeringRequest_finalize_ex(key,deallocate_pointers);
    ...
    RotateEngineeringRequestPluginSupport_destroy_key(
        ...
        EngineeringRotation::RotateEngineeringRequestPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            EngineeringRotation::RotateEngineeringRequestPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            EngineeringRotation::RotateEngineeringRequestPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            EngineeringRotation::RotateEngineeringRequestPluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            EngineeringRotation::RotateEngineeringRequestPluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_key_max_size(
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
        ...
        const RotateEngineeringRequest *src)
    {
        ...
        return EngineeringRotation::RotateEngineeringRequestPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            EngineeringRotation::RotateEngineeringRequest_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const RotateEngineeringRequest *sample)
    {
        ...
        result = EngineeringRotation::RotateEngineeringRequestPlugin_serialize(
        ...
        void *endpoint_plugin_qos)
    {
        ...
        result= EngineeringRotation::RotateEngineeringRequestPlugin_deserialize_sample( 
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= EngineeringRotation::RotateEngineeringRequestPlugin_deserialize_key_sample(
        ...
        const RotateEngineeringRequest *instance)
    {
        ...
        if (!EngineeringRotation::RotateEngineeringRequestPlugin_serialize_key(
            ...
            size = (int)EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
    ...
    {   
      ...
      fin:
        ...
        if (!EngineeringRotation::RotateEngineeringRequestPlugin_instance_to_keyhash(
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        EngineeringRotation::RotateEngineeringRequestPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        EngineeringRotation::RotateEngineeringRequestPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        EngineeringRotation::RotateEngineeringRequestPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        EngineeringRotation::RotateEngineeringRequestPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_copy_sample;
        ...
        EngineeringRotation::RotateEngineeringRequestPlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_sample_min_size;
        ...
        EngineeringRotation::RotateEngineeringRequestPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_serialized_sample_to_keyhash;
        ...
        EngineeringRotation::RotateEngineeringRequestPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        EngineeringRotation::RotateEngineeringRequestPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)EngineeringRotation::RotateEngineeringRequest_get_typecode();
    ...
    * -------------------------------------------------------------------------- */
    ...
    RotateEngineeringObjectivePluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringObjective_initialize_w_params(sample,alloc_params)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }        
    ...
    RotateEngineeringObjectivePluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringObjective_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return EngineeringRotation::RotateEngineeringObjectivePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    RotateEngineeringObjectivePluginSupport_destroy_data_w_params(
        ...
        EngineeringRotation::RotateEngineeringObjective_finalize_w_params(sample,dealloc_params);
    ...
    RotateEngineeringObjectivePluginSupport_destroy_data_ex(
        ...
        EngineeringRotation::RotateEngineeringObjective_finalize_ex(sample,deallocate_pointers);
    ...
    RotateEngineeringObjectivePluginSupport_destroy_data(
        ...
        EngineeringRotation::RotateEngineeringObjectivePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return EngineeringRotation::RotateEngineeringObjective_copy(dst,src);
    }
    ...
    RotateEngineeringObjectivePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        EngineeringRotation::RotateEngineeringObjective_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  EngineeringRotation::RotateEngineeringObjectivePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        EngineeringRotation::RotateEngineeringObjective_finalize_ex(key,deallocate_pointers);
    ...
    RotateEngineeringObjectivePluginSupport_destroy_key(
        ...
        EngineeringRotation::RotateEngineeringObjectivePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            EngineeringRotation::RotateEngineeringObjectivePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            EngineeringRotation::RotateEngineeringObjectivePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            EngineeringRotation::RotateEngineeringObjectivePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            EngineeringRotation::RotateEngineeringObjectivePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return EngineeringRotation::RotateEngineeringObjectivePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            EngineeringRotation::RotateEngineeringObjective_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const RotateEngineeringObjective *sample)
    {
        ...
        result = EngineeringRotation::RotateEngineeringObjectivePlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, 
            RTI_TRUE, NULL);  
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= EngineeringRotation::RotateEngineeringObjectivePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= EngineeringRotation::RotateEngineeringObjectivePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        const RotateEngineeringObjective *instance)
    {
        ...
        if (!EngineeringRotation::RotateEngineeringObjectivePlugin_serialize_key(
            endpoint_data,instance,md5Stream, RTI_FALSE, RTI_CDR_ENCAPSULATION_ID_CDR_BE, RTI_TRUE,NULL)) {
            ...
            size = (int)EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!EngineeringRotation::RotateEngineeringObjectivePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        EngineeringRotation::RotateEngineeringObjectivePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        EngineeringRotation::RotateEngineeringObjectivePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        EngineeringRotation::RotateEngineeringObjectivePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        EngineeringRotation::RotateEngineeringObjectivePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_sample_min_size;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_serialized_sample_to_keyhash;
        ...
        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        EngineeringRotation::RotateEngineeringObjectivePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)EngineeringRotation::RotateEngineeringObjective_get_typecode();
    ...
    * -------------------------------------------------------------------------- */
    ...
    RotateEngineeringStatePluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringState_initialize_w_params(sample,alloc_params)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }        
    ...
    RotateEngineeringStatePluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!EngineeringRotation::RotateEngineeringState_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return EngineeringRotation::RotateEngineeringStatePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    RotateEngineeringStatePluginSupport_destroy_data_w_params(
        ...
        EngineeringRotation::RotateEngineeringState_finalize_w_params(sample,dealloc_params);
    ...
    RotateEngineeringStatePluginSupport_destroy_data_ex(
        ...
        EngineeringRotation::RotateEngineeringState_finalize_ex(sample,deallocate_pointers);
    ...
    RotateEngineeringStatePluginSupport_destroy_data(
        ...
        EngineeringRotation::RotateEngineeringStatePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return EngineeringRotation::RotateEngineeringState_copy(dst,src);
    }
    ...
    RotateEngineeringStatePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        EngineeringRotation::RotateEngineeringState_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  EngineeringRotation::RotateEngineeringStatePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        EngineeringRotation::RotateEngineeringState_finalize_ex(key,deallocate_pointers);
    ...
    RotateEngineeringStatePluginSupport_destroy_key(
        ...
        EngineeringRotation::RotateEngineeringStatePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            EngineeringRotation::RotateEngineeringStatePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            EngineeringRotation::RotateEngineeringStatePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            EngineeringRotation::RotateEngineeringStatePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            EngineeringRotation::RotateEngineeringStatePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return EngineeringRotation::RotateEngineeringStatePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            EngineeringRotation::RotateEngineeringState_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const RotateEngineeringState *sample)
    {
        ...
        result = EngineeringRotation::RotateEngineeringStatePlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, 
            RTI_TRUE, NULL);  
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= EngineeringRotation::RotateEngineeringStatePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= EngineeringRotation::RotateEngineeringStatePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        const RotateEngineeringState *instance)
    {
        ...
        if (!EngineeringRotation::RotateEngineeringStatePlugin_serialize_key(
            endpoint_data,instance,md5Stream, RTI_FALSE, RTI_CDR_ENCAPSULATION_ID_CDR_BE, RTI_TRUE,NULL)) {
            ...
            size = (int)EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!EngineeringRotation::RotateEngineeringStatePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        EngineeringRotation::RotateEngineeringStatePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        EngineeringRotation::RotateEngineeringStatePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        EngineeringRotation::RotateEngineeringStatePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        EngineeringRotation::RotateEngineeringStatePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_sample_min_size;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_serialized_sample_to_keyhash;
        ...
        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        EngineeringRotation::RotateEngineeringStatePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)EngineeringRotation::RotateEngineeringState_get_typecode();
