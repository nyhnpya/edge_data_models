...
namespace nec {
    namespace control {
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::control::RotateRequest_copy(dst,(const RotateRequest*) src);
        }
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::control::RotateObjective_copy(dst,(const RotateObjective*) src);
        }
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::control::RotateState_copy(dst,(const RotateState*) src);
        }
