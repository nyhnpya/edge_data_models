...
namespace CalibrationHoisting {
    ...
    /* ========================================================================= */
    const char *DrillingCalibrationRequestTYPENAME = "CalibrationHoisting::DrillingCalibrationRequest";
    ...
    DDS_TypeCode* DrillingCalibrationRequest_get_typecode()
    {
        ...
        {{
                ...
                -1, /*Ignored*/
                (char *)"CalibrationHoisting::DrillingCalibrationRequest", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool DrillingCalibrationRequest_initialize(
        ...
        return CalibrationHoisting::DrillingCalibrationRequest_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        DrillingCalibrationRequest* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return CalibrationHoisting::DrillingCalibrationRequest_initialize_w_params(
            sample,&allocParams);
        ...
        DrillingCalibrationRequest* sample)
    {
        ...
        CalibrationHoisting::DrillingCalibrationRequest_finalize_ex(sample,RTI_TRUE);
    }
        ...
        DrillingCalibrationRequest* sample,RTIBool deletePointers)
    {
        ...
        CalibrationHoisting::DrillingCalibrationRequest_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params CalibrationHoisting::DrillingCalibrationRequest_initialize_w_params
    #define T_finalize_w_params   CalibrationHoisting::DrillingCalibrationRequest_finalize_w_params
    #define T_copy       CalibrationHoisting::DrillingCalibrationRequest_copy
    ...
    /* ========================================================================= */
    const char *DrillingCalibrationStateTYPENAME = "CalibrationHoisting::DrillingCalibrationState";
    ...
    DDS_TypeCode* DrillingCalibrationState_get_typecode()
    {
        ...
        {{
                ...
                DDS_BOOLEAN_FALSE, /* Ignored */
                -1, /*Ignored*/
                (char *)"CalibrationHoisting::DrillingCalibrationState", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool DrillingCalibrationState_initialize(
        ...
        return CalibrationHoisting::DrillingCalibrationState_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        DrillingCalibrationState* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return CalibrationHoisting::DrillingCalibrationState_initialize_w_params(
            sample,&allocParams);
        ...
        DrillingCalibrationState* sample)
    {
        ...
        CalibrationHoisting::DrillingCalibrationState_finalize_ex(sample,RTI_TRUE);
    }
        ...
        DrillingCalibrationState* sample,RTIBool deletePointers)
    {
        ...
        CalibrationHoisting::DrillingCalibrationState_finalize_w_params(
            sample,&deallocParams);
    }
    ...
    */
    ...
    #define T_initialize_w_params CalibrationHoisting::DrillingCalibrationState_initialize_w_params
    #define T_finalize_w_params   CalibrationHoisting::DrillingCalibrationState_finalize_w_params
    #define T_copy       CalibrationHoisting::DrillingCalibrationState_copy
