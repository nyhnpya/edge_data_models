...
namespace CalibrationHoisting {
    ...
    * -------------------------------------------------------------------------- */
    ...
    DrillingCalibrationRequestPluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!CalibrationHoisting::DrillingCalibrationRequest_initialize_w_params(sample,alloc_params)) {
    ...
    DrillingCalibrationRequestPluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!CalibrationHoisting::DrillingCalibrationRequest_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return CalibrationHoisting::DrillingCalibrationRequestPluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    DrillingCalibrationRequestPluginSupport_destroy_data_w_params(
        ...
        CalibrationHoisting::DrillingCalibrationRequest_finalize_w_params(sample,dealloc_params);
    ...
    DrillingCalibrationRequestPluginSupport_destroy_data_ex(
        ...
        CalibrationHoisting::DrillingCalibrationRequest_finalize_ex(sample,deallocate_pointers);
    ...
    DrillingCalibrationRequestPluginSupport_destroy_data(
        ...
        CalibrationHoisting::DrillingCalibrationRequestPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return CalibrationHoisting::DrillingCalibrationRequest_copy(dst,src);
    }
    ...
    DrillingCalibrationRequestPluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        RTIOsapiHeap_allocateStructure(
            &key, DrillingCalibrationRequestKeyHolder);

        CalibrationHoisting::DrillingCalibrationRequest_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  CalibrationHoisting::DrillingCalibrationRequestPluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        CalibrationHoisting::DrillingCalibrationRequest_finalize_ex(key,deallocate_pointers);
    ...
    DrillingCalibrationRequestPluginSupport_destroy_key(
        ...
        CalibrationHoisting::DrillingCalibrationRequestPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            CalibrationHoisting::DrillingCalibrationRequestPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            CalibrationHoisting::DrillingCalibrationRequestPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            CalibrationHoisting::DrillingCalibrationRequestPluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            CalibrationHoisting::DrillingCalibrationRequestPluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_key_max_size(
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
        ...
        const DrillingCalibrationRequest *src)
    {
        ...
        return CalibrationHoisting::DrillingCalibrationRequestPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            CalibrationHoisting::DrillingCalibrationRequest_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const DrillingCalibrationRequest *sample)
    {
        ...
        result = CalibrationHoisting::DrillingCalibrationRequestPlugin_serialize(
        ...
        void *endpoint_plugin_qos)
    {
        ...
        result= CalibrationHoisting::DrillingCalibrationRequestPlugin_deserialize_sample( 
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= CalibrationHoisting::DrillingCalibrationRequestPlugin_deserialize_key_sample(
        ...
        const DrillingCalibrationRequest *instance)
    {
        ...
        if (!CalibrationHoisting::DrillingCalibrationRequestPlugin_serialize_key(
            ...
            size = (int)CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
    ...
    {   
      ...
      fin:
        ...
        if (!CalibrationHoisting::DrillingCalibrationRequestPlugin_instance_to_keyhash(
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        CalibrationHoisting::DrillingCalibrationRequestPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_copy_sample;
        ...
        CalibrationHoisting::DrillingCalibrationRequestPlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_sample_min_size;
        ...
        CalibrationHoisting::DrillingCalibrationRequestPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_serialized_sample_to_keyhash;
        ...
        CalibrationHoisting::DrillingCalibrationRequestPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        CalibrationHoisting::DrillingCalibrationRequestPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)CalibrationHoisting::DrillingCalibrationRequest_get_typecode();
    ...
    * -------------------------------------------------------------------------- */
    ...
    DrillingCalibrationStatePluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!CalibrationHoisting::DrillingCalibrationState_initialize_w_params(sample,alloc_params)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }        
    ...
    DrillingCalibrationStatePluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!CalibrationHoisting::DrillingCalibrationState_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return CalibrationHoisting::DrillingCalibrationStatePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    DrillingCalibrationStatePluginSupport_destroy_data_w_params(
        ...
        CalibrationHoisting::DrillingCalibrationState_finalize_w_params(sample,dealloc_params);
    ...
    DrillingCalibrationStatePluginSupport_destroy_data_ex(
        ...
        CalibrationHoisting::DrillingCalibrationState_finalize_ex(sample,deallocate_pointers);
    ...
    DrillingCalibrationStatePluginSupport_destroy_data(
        ...
        CalibrationHoisting::DrillingCalibrationStatePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return CalibrationHoisting::DrillingCalibrationState_copy(dst,src);
    }
    ...
    DrillingCalibrationStatePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        RTIOsapiHeap_allocateStructure(
            &key, DrillingCalibrationStateKeyHolder);

        CalibrationHoisting::DrillingCalibrationState_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  CalibrationHoisting::DrillingCalibrationStatePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        CalibrationHoisting::DrillingCalibrationState_finalize_ex(key,deallocate_pointers);
    ...
    DrillingCalibrationStatePluginSupport_destroy_key(
        ...
        CalibrationHoisting::DrillingCalibrationStatePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            CalibrationHoisting::DrillingCalibrationStatePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            CalibrationHoisting::DrillingCalibrationStatePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            CalibrationHoisting::DrillingCalibrationStatePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            CalibrationHoisting::DrillingCalibrationStatePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return CalibrationHoisting::DrillingCalibrationStatePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            CalibrationHoisting::DrillingCalibrationState_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const DrillingCalibrationState *sample)
    {
        ...
        result = CalibrationHoisting::DrillingCalibrationStatePlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, 
            RTI_TRUE, NULL);  
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= CalibrationHoisting::DrillingCalibrationStatePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= CalibrationHoisting::DrillingCalibrationStatePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        const DrillingCalibrationState *instance)
    {
        ...
        if (!CalibrationHoisting::DrillingCalibrationStatePlugin_serialize_key(
            endpoint_data,instance,md5Stream, RTI_FALSE, RTI_CDR_ENCAPSULATION_ID_CDR_BE, RTI_TRUE,NULL)) {
            ...
            size = (int)CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!CalibrationHoisting::DrillingCalibrationStatePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        CalibrationHoisting::DrillingCalibrationStatePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        CalibrationHoisting::DrillingCalibrationStatePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        CalibrationHoisting::DrillingCalibrationStatePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        CalibrationHoisting::DrillingCalibrationStatePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_sample_min_size;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_serialized_sample_to_keyhash;
        ...
        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        CalibrationHoisting::DrillingCalibrationStatePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)CalibrationHoisting::DrillingCalibrationState_get_typecode();
