...
namespace AutoDrillerConfiguration {
    ...
    * -------------------------------------------------------------------------- */
        ...
        unsigned int indent_level)
    {
        ...
        RTICdrType_printDouble(
            &sample->torqueKpCurrent, "torqueKpCurrent", indent_level + 1);    

        RTICdrType_printDouble(
            &sample->torqueTiCalculated, "torqueTiCalculated", indent_level + 1);    
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(serialize_sample) {
            ...
            if (!RTICdrStream_serializeDouble(
                stream, &sample->torqueKpCalculated)) {
                return RTI_FALSE;
            }

            if (!RTICdrStream_serializeDouble(
                stream, &sample->torqueKpCurrent)) {
                return RTI_FALSE;
            }

            if (!RTICdrStream_serializeDouble(
                stream, &sample->torqueTiCalculated)) {
                return RTI_FALSE;
            }

            if (!RTICdrStream_serializeDouble(
                stream, &sample->toqueTiCurrent)) {
                return RTI_FALSE;
            }
    ...
    * -------------------------------------------------------------------------- */
        ...
        unsigned int indent_level)
    {
        ...
        RTICdrType_printDouble(
            &sample->differentialPressurePreFilter, "differentialPressurePreFilter", indent_level + 1);    
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(serialize_sample) {
            ...
            if (!RTICdrStream_serializeDouble(
                stream, &sample->differentialPressurePreFilter)) {
                return RTI_FALSE;
            }
