...
namespace ControlRotation {
    ...
    /* ========================================================================= */
    const char *TorqueRequestTYPENAME = "ControlRotation::TorqueRequest";
    ...
    DDS_TypeCode* TorqueRequest_get_typecode()
    {
        ...
        {{
                ...
                -1, /*Ignored*/
                (char *)"ControlRotation::TorqueRequest", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool TorqueRequest_initialize(
        ...
        return ControlRotation::TorqueRequest_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        TorqueRequest* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return ControlRotation::TorqueRequest_initialize_w_params(
            sample,&allocParams);
        ...
        TorqueRequest* sample)
    {
        ...
        ControlRotation::TorqueRequest_finalize_ex(sample,RTI_TRUE);
    }
        ...
        TorqueRequest* sample,RTIBool deletePointers)
    {
        ...
        ControlRotation::TorqueRequest_finalize_w_params(
    ...
    */
    ...
    #define T_initialize_w_params ControlRotation::TorqueRequest_initialize_w_params
    #define T_finalize_w_params   ControlRotation::TorqueRequest_finalize_w_params
    #define T_copy       ControlRotation::TorqueRequest_copy
    ...
    /* ========================================================================= */
    const char *TorqueObjectiveTYPENAME = "ControlRotation::TorqueObjective";
    ...
    DDS_TypeCode* TorqueObjective_get_typecode()
    {
        ...
        {{
                ...
                DDS_BOOLEAN_FALSE, /* Ignored */
                -1, /*Ignored*/
                (char *)"ControlRotation::TorqueObjective", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool TorqueObjective_initialize(
        ...
        return ControlRotation::TorqueObjective_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        TorqueObjective* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return ControlRotation::TorqueObjective_initialize_w_params(
            sample,&allocParams);
        ...
        TorqueObjective* sample)
    {
        ...
        ControlRotation::TorqueObjective_finalize_ex(sample,RTI_TRUE);
    }
        ...
        TorqueObjective* sample,RTIBool deletePointers)
    {
        ...
        ControlRotation::TorqueObjective_finalize_w_params(
            sample,&deallocParams);
    }
    ...
    */
    ...
    #define T_initialize_w_params ControlRotation::TorqueObjective_initialize_w_params
    #define T_finalize_w_params   ControlRotation::TorqueObjective_finalize_w_params
    #define T_copy       ControlRotation::TorqueObjective_copy
    ...
    /* ========================================================================= */
    const char *TorqueStateTYPENAME = "ControlRotation::TorqueState";
    ...
    DDS_TypeCode* TorqueState_get_typecode()
    {
        ...
        {{
                ...
                DDS_BOOLEAN_FALSE, /* Ignored */
                -1, /*Ignored*/
                (char *)"ControlRotation::TorqueState", /* Name */
                NULL, /* Ignored */      
                0, /* Ignored */
                0, /* Ignored */
                NULL, /* Ignored */
    ...
    RTIBool TorqueState_initialize(
        TorqueState* sample) {
        return ControlRotation::TorqueState_initialize_ex(sample,RTI_TRUE,RTI_TRUE);
    }
        ...
        TorqueState* sample,RTIBool allocatePointers, RTIBool allocateMemory)
    {
        ...
        return ControlRotation::TorqueState_initialize_w_params(
            sample,&allocParams);
        ...
        TorqueState* sample)
    {
        ...
        ControlRotation::TorqueState_finalize_ex(sample,RTI_TRUE);
    }
        ...
        TorqueState* sample,RTIBool deletePointers)
    {
        ...
        ControlRotation::TorqueState_finalize_w_params(
            sample,&deallocParams);
    }
    ...
    */
    ...
    #define T_initialize_w_params ControlRotation::TorqueState_initialize_w_params
    #define T_finalize_w_params   ControlRotation::TorqueState_finalize_w_params
    #define T_copy       ControlRotation::TorqueState_copy
