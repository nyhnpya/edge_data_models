...
#ifndef hoistSupport_1013697580_h
#define hoistSupport_1013697580_h
...
namespace nec {
    namespace process {
        ...
        */
        ...
        #define ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
        DDS_DATAWRITER_WITH_DATA_CONSTRUCTOR_METHODS_CPP(HoistObjectiveDataWriter, HoistObjective);
        #undef ENABLE_TDATAWRITER_DATA_CONSTRUCTOR_METHODS
        #define ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
        DDS_DATAREADER_W_DATA_CONSISTENCY_CHECK(HoistObjectiveDataReader, HoistObjectiveSeq, HoistObjective);
        #undef ENABLE_TDATAREADER_DATA_CONSISTENCY_CHECK_METHOD
...
#endif  /* hoistSupport_1013697580_h */
