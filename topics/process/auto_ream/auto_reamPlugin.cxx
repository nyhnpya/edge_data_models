...
namespace nec {
    namespace process {
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::process::AutoReamRequest_copy(dst,src);
        }
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::process::AutoReamObjective_copy(dst,src);
        }
        ...
        AutoReamObjectivePluginSupport_create_key_ex(RTIBool allocate_pointers){
            ...
            RTIOsapiHeap_allocateStructure(
                &key, AutoReamObjectiveKeyHolder);
        ...
        * -------------------------------------------------------------------------- */
        ...
        {
            return nec::process::AutoReamState_copy(dst,src);
        }
