...
namespace Hoisting {
    ...
    * -------------------------------------------------------------------------- */
    ...
    DrillingRequestPluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingRequest_initialize_w_params(sample,alloc_params)) {
    ...
    DrillingRequestPluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingRequest_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return Hoisting::DrillingRequestPluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    DrillingRequestPluginSupport_destroy_data_w_params(
        ...
        Hoisting::DrillingRequest_finalize_w_params(sample,dealloc_params);
    ...
    DrillingRequestPluginSupport_destroy_data_ex(
        ...
        Hoisting::DrillingRequest_finalize_ex(sample,deallocate_pointers);
    ...
    DrillingRequestPluginSupport_destroy_data(
        ...
        Hoisting::DrillingRequestPluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return Hoisting::DrillingRequest_copy(dst,src);
    }
    ...
    DrillingRequestPluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        Hoisting::DrillingRequest_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  Hoisting::DrillingRequestPluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        Hoisting::DrillingRequest_finalize_ex(key,deallocate_pointers);
    ...
    DrillingRequestPluginSupport_destroy_key(
        ...
        Hoisting::DrillingRequestPluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            Hoisting::DrillingRequestPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Hoisting::DrillingRequestPluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Hoisting::DrillingRequestPluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Hoisting::DrillingRequestPluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Hoisting::DrillingRequestPlugin_get_serialized_key_max_size(
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Hoisting::DrillingRequestPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                Hoisting::DrillingRequestPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Hoisting::DrillingRequestPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
        ...
        const DrillingRequest *src)
    {
        ...
        return Hoisting::DrillingRequestPluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            Hoisting::DrillingRequest_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const DrillingRequest *sample)
    {
        ...
        result = Hoisting::DrillingRequestPlugin_serialize(
        ...
        void *endpoint_plugin_qos)
    {
        ...
        result= Hoisting::DrillingRequestPlugin_deserialize_sample( 
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Hoisting::DrillingRequestPlugin_deserialize_key_sample(
        ...
        const DrillingRequest *instance)
    {
        ...
        if (!Hoisting::DrillingRequestPlugin_serialize_key(
            ...
            size = (int)Hoisting::DrillingRequestPlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
    ...
    {   
      ...
      fin:
        ...
        if (!Hoisting::DrillingRequestPlugin_instance_to_keyhash(
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        Hoisting::DrillingRequestPlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Hoisting::DrillingRequestPlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Hoisting::DrillingRequestPlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Hoisting::DrillingRequestPlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Hoisting::DrillingRequestPlugin_copy_sample;
        ...
        Hoisting::DrillingRequestPlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Hoisting::DrillingRequestPlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Hoisting::DrillingRequestPlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Hoisting::DrillingRequestPlugin_get_serialized_sample_min_size;
        ...
        Hoisting::DrillingRequestPlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Hoisting::DrillingRequestPlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Hoisting::DrillingRequestPlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Hoisting::DrillingRequestPlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Hoisting::DrillingRequestPlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Hoisting::DrillingRequestPlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Hoisting::DrillingRequestPlugin_serialized_sample_to_keyhash;
        ...
        Hoisting::DrillingRequestPlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Hoisting::DrillingRequestPlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Hoisting::DrillingRequest_get_typecode();
    ...
    * -------------------------------------------------------------------------- */
    ...
    DrillingObjectivePluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingObjective_initialize_w_params(sample,alloc_params)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }        
    ...
    DrillingObjectivePluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingObjective_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return Hoisting::DrillingObjectivePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    DrillingObjectivePluginSupport_destroy_data_w_params(
        ...
        Hoisting::DrillingObjective_finalize_w_params(sample,dealloc_params);
    ...
    DrillingObjectivePluginSupport_destroy_data_ex(
        ...
        Hoisting::DrillingObjective_finalize_ex(sample,deallocate_pointers);
    ...
    DrillingObjectivePluginSupport_destroy_data(
        ...
        Hoisting::DrillingObjectivePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return Hoisting::DrillingObjective_copy(dst,src);
    }
    ...
    DrillingObjectivePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        Hoisting::DrillingObjective_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  Hoisting::DrillingObjectivePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        Hoisting::DrillingObjective_finalize_ex(key,deallocate_pointers);
    ...
    DrillingObjectivePluginSupport_destroy_key(
        ...
        Hoisting::DrillingObjectivePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            Hoisting::DrillingObjectivePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Hoisting::DrillingObjectivePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Hoisting::DrillingObjectivePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Hoisting::DrillingObjectivePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Hoisting::DrillingObjectivePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Hoisting::DrillingObjectivePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                Hoisting::DrillingObjectivePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Hoisting::DrillingObjectivePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return Hoisting::DrillingObjectivePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            Hoisting::DrillingObjective_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const DrillingObjective *sample)
    {
        ...
        result = Hoisting::DrillingObjectivePlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, 
            RTI_TRUE, NULL);  
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Hoisting::DrillingObjectivePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Hoisting::DrillingObjectivePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        const DrillingObjective *instance)
    {
        ...
        if (!Hoisting::DrillingObjectivePlugin_serialize_key(
            endpoint_data,instance,md5Stream, RTI_FALSE, RTI_CDR_ENCAPSULATION_ID_CDR_BE, RTI_TRUE,NULL)) {
            ...
            size = (int)Hoisting::DrillingObjectivePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!Hoisting::DrillingObjectivePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        Hoisting::DrillingObjectivePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Hoisting::DrillingObjectivePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Hoisting::DrillingObjectivePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Hoisting::DrillingObjectivePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Hoisting::DrillingObjectivePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        Hoisting::DrillingObjectivePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Hoisting::DrillingObjectivePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Hoisting::DrillingObjectivePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Hoisting::DrillingObjectivePlugin_get_serialized_sample_min_size;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        Hoisting::DrillingObjectivePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Hoisting::DrillingObjectivePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Hoisting::DrillingObjectivePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Hoisting::DrillingObjectivePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Hoisting::DrillingObjectivePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Hoisting::DrillingObjectivePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Hoisting::DrillingObjectivePlugin_serialized_sample_to_keyhash;
        ...
        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        Hoisting::DrillingObjectivePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Hoisting::DrillingObjectivePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Hoisting::DrillingObjective_get_typecode();
    ...
    * -------------------------------------------------------------------------- */
    ...
    DrillingStatePluginSupport_create_data_w_params(
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingState_initialize_w_params(sample,alloc_params)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }        
    ...
    DrillingStatePluginSupport_create_data_ex(RTIBool allocate_pointers){
        ...
        if(sample != NULL) {
            if (!Hoisting::DrillingState_initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                RTIOsapiHeap_freeStructure(sample);
                return NULL;
            }
        }
    ...
    {
        return Hoisting::DrillingStatePluginSupport_create_data_ex(RTI_TRUE);
    }
    ...
    DrillingStatePluginSupport_destroy_data_w_params(
        ...
        Hoisting::DrillingState_finalize_w_params(sample,dealloc_params);
    ...
    DrillingStatePluginSupport_destroy_data_ex(
        ...
        Hoisting::DrillingState_finalize_ex(sample,deallocate_pointers);
    ...
    DrillingStatePluginSupport_destroy_data(
        ...
        Hoisting::DrillingStatePluginSupport_destroy_data_ex(sample,RTI_TRUE);
    ...
    {
        return Hoisting::DrillingState_copy(dst,src);
    }
    ...
    DrillingStatePluginSupport_create_key_ex(RTIBool allocate_pointers){
        ...
        Hoisting::DrillingState_initialize_ex(key,allocate_pointers, RTI_TRUE);
        return key;
    }
    ...
    {
        return  Hoisting::DrillingStatePluginSupport_create_key_ex(RTI_TRUE);
    }
    ...
    {
        Hoisting::DrillingState_finalize_ex(key,deallocate_pointers);
    ...
    DrillingStatePluginSupport_destroy_key(
        ...
        Hoisting::DrillingStatePluginSupport_destroy_key_ex(key,RTI_TRUE);
    ...
    * ---------------------------------------------------------------------------- */
        ...
        void *containerPluginContext)
    {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            Hoisting::DrillingStatePluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            Hoisting::DrillingStatePluginSupport_destroy_data,
            (PRESTypePluginDefaultEndpointDataCreateKeyFunction)
            Hoisting::DrillingStatePluginSupport_create_key ,            
            (PRESTypePluginDefaultEndpointDataDestroyKeyFunction)
            Hoisting::DrillingStatePluginSupport_destroy_key);

        if (epd == NULL) {
            return NULL;
        } 
        serializedKeyMaxSize =  Hoisting::DrillingStatePlugin_get_serialized_key_max_size(
            epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = Hoisting::DrillingStatePlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                Hoisting::DrillingStatePlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                Hoisting::DrillingStatePlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
                PRESTypePluginDefaultEndpointData_delete(epd);
                return NULL;
            }
    ...
    {
        if (endpoint_data) {} /* To avoid warnings */
        return Hoisting::DrillingStatePluginSupport_copy_data(dst,src);
    }
    ...
    * ------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            Hoisting::DrillingState_initialize_ex(sample, RTI_FALSE, RTI_FALSE);
        ...
        const DrillingState *sample)
    {
        ...
        result = Hoisting::DrillingStatePlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTI_CDR_ENCAPSULATION_ID_CDR_NATIVE, 
            RTI_TRUE, NULL);  
        ...
        void *endpoint_plugin_qos)
    {
        ...
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Hoisting::DrillingStatePlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
    ...
    * -------------------------------------------------------------------------------------- */
        ...
        void *endpoint_plugin_qos)
    {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= Hoisting::DrillingStatePlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
        ...
        const DrillingState *instance)
    {
        ...
        if (!Hoisting::DrillingStatePlugin_serialize_key(
            endpoint_data,instance,md5Stream, RTI_FALSE, RTI_CDR_ENCAPSULATION_ID_CDR_BE, RTI_TRUE,NULL)) {
            ...
            size = (int)Hoisting::DrillingStatePlugin_get_serialized_sample_size(
                endpoint_data,
                RTI_FALSE,
                RTI_CDR_ENCAPSULATION_ID_CDR_BE,
                0,
    ...
    {   
      ...
      fin:
        ...
        if (!Hoisting::DrillingStatePlugin_instance_to_keyhash(
            endpoint_data, keyhash, sample)) {
            return RTI_FALSE;
        }
    ...
    * ------------------------------------------------------------------------ */
    ...
    { 
        ...
        plugin->onParticipantAttached =
        (PRESTypePluginOnParticipantAttachedCallback)
        Hoisting::DrillingStatePlugin_on_participant_attached;
        plugin->onParticipantDetached =
        (PRESTypePluginOnParticipantDetachedCallback)
        Hoisting::DrillingStatePlugin_on_participant_detached;
        plugin->onEndpointAttached =
        (PRESTypePluginOnEndpointAttachedCallback)
        Hoisting::DrillingStatePlugin_on_endpoint_attached;
        plugin->onEndpointDetached =
        (PRESTypePluginOnEndpointDetachedCallback)
        Hoisting::DrillingStatePlugin_on_endpoint_detached;

        plugin->copySampleFnc =
        (PRESTypePluginCopySampleFunction)
        Hoisting::DrillingStatePlugin_copy_sample;
        plugin->createSampleFnc =
        (PRESTypePluginCreateSampleFunction)
        ...
        plugin->serializeFnc =
        (PRESTypePluginSerializeFunction)
        Hoisting::DrillingStatePlugin_serialize;
        plugin->deserializeFnc =
        (PRESTypePluginDeserializeFunction)
        Hoisting::DrillingStatePlugin_deserialize;
        plugin->getSerializedSampleMaxSizeFnc =
        (PRESTypePluginGetSerializedSampleMaxSizeFunction)
        Hoisting::DrillingStatePlugin_get_serialized_sample_max_size;
        plugin->getSerializedSampleMinSizeFnc =
        (PRESTypePluginGetSerializedSampleMinSizeFunction)
        Hoisting::DrillingStatePlugin_get_serialized_sample_min_size;
        ...
        plugin->getKeyKindFnc =
        (PRESTypePluginGetKeyKindFunction)
        Hoisting::DrillingStatePlugin_get_key_kind;

        plugin->getSerializedKeyMaxSizeFnc =   
        (PRESTypePluginGetSerializedKeyMaxSizeFunction)
        Hoisting::DrillingStatePlugin_get_serialized_key_max_size;
        plugin->serializeKeyFnc =
        (PRESTypePluginSerializeKeyFunction)
        Hoisting::DrillingStatePlugin_serialize_key;
        plugin->deserializeKeyFnc =
        (PRESTypePluginDeserializeKeyFunction)
        Hoisting::DrillingStatePlugin_deserialize_key;
        plugin->deserializeKeySampleFnc =
        (PRESTypePluginDeserializeKeySampleFunction)
        Hoisting::DrillingStatePlugin_deserialize_key_sample;

        plugin-> instanceToKeyHashFnc = 
        (PRESTypePluginInstanceToKeyHashFunction)
        Hoisting::DrillingStatePlugin_instance_to_keyhash;
        plugin->serializedSampleToKeyHashFnc = 
        (PRESTypePluginSerializedSampleToKeyHashFunction)
        Hoisting::DrillingStatePlugin_serialized_sample_to_keyhash;
        ...
        plugin->instanceToKeyFnc =
        (PRESTypePluginInstanceToKeyFunction)
        Hoisting::DrillingStatePlugin_instance_to_key;
        plugin->keyToInstanceFnc =
        (PRESTypePluginKeyToInstanceFunction)
        Hoisting::DrillingStatePlugin_key_to_instance;
        plugin->serializedKeyToKeyHashFnc = NULL; /* Not supported yet */
        plugin->typeCode =  (struct RTICdrTypeCode *)Hoisting::DrillingState_get_typecode();
