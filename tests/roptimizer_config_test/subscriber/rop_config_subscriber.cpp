...
CRoptimizerConfigurationRequestSubscriber::CConfigurationStateRequestSubscriber *pSubscriber = new CRoptimizerConfigurationRequestSubscriber::CConfigurationStateRequestSubscriber();
...
void get_data(const DDS::SampleInfo &sampleInfo)
{
    double value; 

    mvprintw(2, 1, "Steady State Window: [%d]", pSubscriber->GetSteadyStateWindow());
    mvprintw(4, 1, "Steady State Min: [%d]", pSubscriber->GetSteadyStateMin());
    mvprintw(6, 1, "RPM Step Size [%d]", pSubscriber->GetRpmStepSize());
    mvprintw(8, 1, "ROP Step Size [%d]", pSubscriber->GetRopStepSize());
