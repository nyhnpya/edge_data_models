...
#        out.write('\n')
    ...
    out.write('\n')        
    out.write('    private:\n')        
    out.write('        {0: <70}'.format(util_gen.module_name + struct.name_camel_case) + 'm_data;\n')        
    out.write('        {0: <70}'.format('DDS::SampleInfo') + 'm_sampleInfo;\n')        
    out.write('        {0: <70}'.format('DDS::LivelinessChangedStatus') + 'm_livelinessStatus;\n')        
    out.write('        {0: <70}'.format('OnDataAvailableEvent') + 'm_pOnDataAvailable;\n')        
    out.write('        {0: <70}'.format('OnDataDisposedEvent') + 'm_pOnDataDisposed;\n')        
    out.write('        {0: <70}'.format('OnLivelinessChangedEvent') + 'm_pOnLivelinessChanged;\n')        
    out.write('};\n')
    out.write('\n')
