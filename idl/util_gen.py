...
def write_makefile(outdir, struct_names, struct_names2):
    ...
    out.write('TARGET_TYPE = staticlib\n')
...
#    out.write('TARG_SOURCES += ' + idl_name + '_publish_io.cxx\n')
    ...
    out.write('PACKAGE_DEPENDENCIES = liblogger.a (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION)),\n')
    out.write('PACKAGE_DEPENDENCIES += libdds_base.a (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION)),\n')
    out.write('PACKAGE_DEPENDENCIES += libbase_data_types.a (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION))\n')
    out.write('PACKAGE_DEV_DEPENDENCIES = liblogger.a-dev (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION)),\n')
    out.write('PACKAGE_DEV_DEPENDENCIES += libdds_base.a-dev (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION)),\n')
    out.write('PACKAGE_DEV_DEPENDENCIES += libbase_data_types.a-dev (= $(TARG_BUILD_MAJOR).$(TARG_BUILD_MINOR).$(TARG_BUILD_PATCH).$(TARG_BUILD_REVISION))\n')
